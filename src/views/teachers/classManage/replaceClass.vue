<template>
  <div class="main-box">
      ...
      <div class="content-box">
        ...
        <template>
          ...
          >
            ...
            <el-table-column prop="date" label="Evaluate Student" align="center" width="250">
              <template slot-scope="scope">
                <ul class="students" v-for="(item,index) in scope.row.students" :key="index">
                  <li>
                    ...
                    <span>
                      ...
                      <el-button
                        ...
                        size="mini"
                        v-if="item.evaluateId != null"
                        @click="editEval(scope.$index,item.phone,item.id,item.evaluateId)"
                        style="width:90px;"
                      >Edit</el-button>
                    </span>
                  </li>
            ...
            <!-- <el-table-column label="操作" align="center" v-if="STactive">
              <template slot-scope="scope">
                <el-button
                  type="primary"
                  size="mini"
    ...
    <div class="item o-hidden mb-20" v-if="replaceOrMackup">
      <div class="h-40 border-bottom t-center">设定替换的老师</div>
...
export default {
  ...
  computed: {
      ...mapGetters(['detailPhone', 'detailType', 'detailInfo', 'ruserInfo', 'roleIds', 'userId'])
    },
