        ...
        <div class="pt-5 pb-15">
          <el-table :data="studentsList" border style="width: 100%">
            ...
            <el-table-column align="center" label="Student Specs">
              <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="gotoClassSituation(scope)">Go</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" label="Detail"
              ...
              <template slot-scope="scope">
                <el-button size="mini" type="success"
                           @click="gotoUserDetail(scope.row.phone)">Click
                </el-button>
              </template>
            </el-table-column>
            ...
            <td>
              ...
              <div class="span pull-left">
                <span class="mr-10 pull-left"
                      v-for="c in detail.teacherWeektime">{{c.week | replaceWeek}}[{{c.teacherType == '0' ? 'CT' : 'FT'}}]</span>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              ...
              <div class="span pull-left">
                ...
                <el-button
                  v-if="detail.chineseTeacherName"
            ...
            <td>
              ...
              <div class="span pull-left">
                <el-button
                  v-if="detail.foreignTeacherName"
            ...
            <el-table-column align="center" label="Student Specs">
              <template slot-scope="scope">
                <el-button size="mini" type="primary"
                           @click="gotoClassSituation(scope)">Go
                </el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" label="Detail"
          ...
          <div class="h-40 mt-10">
            ...
            <div class="pull-left">
              <el-date-picker class="width-300"
                              value-format="yyyy-MM-dd" v-model="editClass.startTime"
...
<script>
  ...
  import {sfData, sfTools} from '../../../aom/util.js';
  ...
  export default {
    ...
    methods: {
      ...
      gotoClassSituation(scope) {
        sessionStorage.setItem('chName', scope.row.name)
        sessionStorage.setItem('engName', scope.row.enName)
        this.$router.push({
          path: 'ruserClassInfo',
          query: {
      ...
      gotoCourse() {
        ...
        this.$router.push({
          path: 'classCourse',
          query: {name: this.detail.courseName, classId: this.classId}
        });
      },
      ...
      gotoSituation() {
        this.$router.push({path: 'classSituation', query: {name: this.name, classId: this.classId}});
      },
      classTypeClick() {
