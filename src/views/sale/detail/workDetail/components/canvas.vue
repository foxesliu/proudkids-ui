<template>
  <div class="layout">
    ...
    <!--作业批改-->
    <!--</div>-->
    <!--&lt;!&ndash;<div class="nav" style="position:fixed;top: 10px;">&ndash;&gt;-->
    <!--&lt;!&ndash;<mu-flat-button v-for="tab in tabs" :key="tab.name" :label="tab.name" class="tab demo-flat-button" :icon="tab.icon" @click="tabfun(tab.fun)" color="#6e86fd" backgroundColor="#FFFFFF" />&ndash;&gt;-->
    <!--&lt;!&ndash;<a href="javascript:void(0);" ref="download" download="picture.png" v-show="false"></a>&ndash;&gt;-->
    <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--</div>-->
...
<script>
  import testImg from '../../../../../assets/img/15.png'
    ...
    methods: {
      ...
      draw_graph(graphType) {
        ...
        let mouseup = (e) => {
          ...
          endY = e.pageY - document.documentElement.scrollTop
          this.canDraw = false
