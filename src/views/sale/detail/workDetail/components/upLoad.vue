        ...
        <div class="mid flex-box">
          ...
          >
            <div class="flex-box btn-box">
              <div class="btn uploadBtn" @click.prevent="upLoad">
                <img src="../../../../../assets/workDetail/updatafile.png" alt style="margin: 0;margin-bottom: 8px">
              </div>
            </div>
          </file-upload>
        </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.url = '/zuul/apps/ph/material/uploadMaterial?lessonId=' + lessonId + '&courseId=' + courseId + '&ruserId=' + ruserId
