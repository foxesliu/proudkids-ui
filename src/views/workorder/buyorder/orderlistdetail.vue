<template>
    <div class="main-box">
        ...
        <div class="btns">
            ...
            <el-button type="primary" size="small" style="width:150px"  @click="gotoPage()" v-if="!show">教务排班操作</el-button>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            trueOrder(){
              buyBills(this.userId, this.taskId, 1, this.params)
              .then(res => {
                  this.$router.push(
                    {path: 'buyorder',
