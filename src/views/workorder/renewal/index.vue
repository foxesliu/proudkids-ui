        ...
        methods: {
            ...
            gotopage(item) {
                if(item.stat == 3){
                    ...
                    this.$router.push({path: '/workorder/renewalcomfirmlist',query:{stat:item.stat,billType:this.type}})
                }
                else if(item.stat == 2){
                    
                    this.$router.push({path: '/workorder/renewalbills',query:{stat:item.stat,title:this.title,type:this.type}})
                }
                else if(item.stat == -1){
                    this.$router.push({path: '/workorder/renewalbills',query:{stat:item.stat,title:this.title,type:this.type}})
                }
