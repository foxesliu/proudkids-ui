        ...
        methods: {
            ...
            gotopage(item) {
                if(item.stat == 3){
                    ...
                    this.$router.push({path: '/workorder/stopconfirm',query:{stat:item.stat,billType:this.type}})
                }
                 if(item.stat == 2){
                    
                    this.$router.push({path: '/workorder/stopbills',query:{stat:item.stat,title:this.title,type:this.type}})
                }
                 if(item.stat == -1){
                    this.$router.push({path: '/workorder/stopbills',query:{stat:item.stat,title:this.title,type:this.type}})
                }
