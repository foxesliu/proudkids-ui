    ...
    export default {
        ...
        methods: {
            ...
            gotoPage(index) {
                ...
                this.$router.push({
                    path: '/workorder/stopbillsdetail',
            ...
            searchUser(){
                ...
                .then(res=>{
                    ...
                    for(var i=0;i<data.length;i++){
                        data[i].startTime = data[i].jsonObj.startTime
                        data[i].endTime = data[i].jsonObj.endTime
                        data[i].periods = data[i].jsonObj.periods
                    }                 
                })
                .catch(res=>{
                    console.log(res);
        ...
        created() {
            ...
            console.log(this.checkWorkList.type)
