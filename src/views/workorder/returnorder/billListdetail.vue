<template>
    ...
    <div class="main-box">
        ...
        <div class="pay-details border">
            <p class="reson"><span>退课理由：</span>{{resonRemark}}</p>
            <div class="pay-details-table-box">
                
                <p class="tip1"><span>退课方式：</span>{{returnWay}}</p>
                ...
                <p class="tip2" v-if="show2">工单已结束</p> 
                 <p class="tip3" v-if="!show"><span>拒绝理由：</span>{{reson}}</p>   
    ...
    export default {
        ...
        created(){
            ...
            .then(res => {
                ...
                console.log(JSON.parse(this.data.billJson))
                this.resonRemark = JSON.parse(this.data.billJson).remark
                this.returnWay =JSON.parse(this.data.billJson).payInfo
                ...
                if(this.data.stat == 2){
                    this.show2 = false
                    this.title = '退课工单>流程中>工单详情'
                }
                if(this.data.stat == 3){
                    this.title = '退课工单>待审核>工单详情'
                }
                if(this.data.stat == -1){
                    this.title = '退课工单>未通过>工单详情'
                    this.show = false
                    this.reson = JSON.parse(this.data.resRemark).remark1
                }
                if(this.data.stat == 1){
                    this.title = '退课工单>已通过>工单详情'
                 }
